...
function App() {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?q=${location}&units=imperial&appid=3f083069e45480c8a8f6f8ff35c0e35a`
  ...
  return (
    <div className="app">
      <div className="search">
        <h2>SAIFDINIE IFWAT BIN MUHAMMAD ZAIDI</h2>
        <h2>AM2107009557</h2>
        <input
          value={location}
